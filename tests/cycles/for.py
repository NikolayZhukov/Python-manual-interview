...
"""
Вывести треугольник из чисел, где каждая строка содержит повторяющееся 
число - цифра 2 повторяется 2 раза, цифра 3 - 3 раза и т.д.
1
2 2
3 3 3
4 4 4 4
...
"""
"""
1 способ - более читаемый, меньше кода, меньше операций
"""
# n = 3
...
"""
Напишите программу, которая выводит все пары учеников для совместной работы 
из двух разных классов.
...
# digs = [4, 3, 100, -53, -30, 1, 34, -8]
# for i in digs:
#     digs = [0 if i < 0 else i for i in digs]
# print(digs)
