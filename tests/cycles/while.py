...
"""
С помощью цикла while напишите программу, которая выводит все нечетные числа от 1 до 10
включительно. Все числа должны быть выведены в одну строку через пробел.
"""
# i = 1
# while i <= 10:
#     if i % 2 == 0:
