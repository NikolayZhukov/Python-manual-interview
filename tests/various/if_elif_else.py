""""""
"""
elif != if - потому что else относится только ко второму if 
"""
# a = 5
# if a > 0:
#     print("положительное")
...
if password == "admin123":
    ...
    level = int(input("Введите уровень доступа (1–5): "))

    if level >= 3:
        print("Доступ разрешён.")

        if level >= 4:
            print("Вы можете изменять настройки системы.")

            if level == 5:
                print("Полные права администратора!")

            if level > 9:
                print("У тебя любопытный уровень доступа")

                if level == 11:
                    print("Ты директор, тебе можно всё!")
    else:
        print("Недостаточный уровень доступа.")
else:
